...
val productsMap = products.map(p=>(p.split(",")(0), p.split(",")(1), p.split(",")(2), p.split(",")(3), p.split(",")(4)))
val productsMapDF = productsMap.toDF("productlD","productCode","name","quantity","price") 
